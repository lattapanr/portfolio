    ...
    return (
        ...
        >
            ...
            <div className="w-[80%] md:w-[60%] lg:w-[65%] md:flex justify-center flex-col items-center gap-6 md:h-[300px] md:justify-between">
                <h3 className="uppercase font-bold pb-10 text-3xl sm:text-4xl text-center sm:my-10 md:hidden">
                    About Me
                </h3>
                ...
                <div className="flex items-center justify-between mx-auto w-full sm:w-[70%] md:w-full lg:w-[80%] sm:my-10 md:my-0">
