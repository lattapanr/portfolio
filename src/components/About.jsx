...
const About = () => {
  ...
  I'm Lattapan (I also go by Noey), a web designer and developer passionate about creating visually appealing and high-performance websites. This site is a testament to my skills in HTML, CSS, JavaScript, React, Tailwind, API integrations and CMS platform like WordPress, showcasing my dedication to web development as my favorite hobby.
</p>

<p className="text-center pb-6 lg:pb-0">
