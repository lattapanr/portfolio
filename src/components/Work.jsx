...
const ProjectItem = ({ image, title, demoLink, codeLink }) => (
    <div
        ...
        className="shadow-sm shadow-primary group container flex justify-center items-center mx-auto content-div bg-cover bg-no-repeat bg-center h-[22vh] sm:h-[30vh] max-w-xs  lg:max-w-md"
    >
