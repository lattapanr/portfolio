...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <nav>
      <div className="fixed w-full h-[80px] bg-white/90 dark:bg-primary/90 dark:text-darkText px-4 flex justify-between items-center text-primary xl:px-[100px] 2xl:px-[200px]">
        {/* Dark mode icon */}
        <div
          color={"#1C1918"}
